...
# --- Authentication Setup (for stauth 0.4.2) ---
credentials = {
    "usernames": {
    ...
    with tab3:
        ...
        if not df_books.empty:
            ...
            if book_choice:
                ...
                new_format = st.selectbox("Format", formats, index=formats.index(current_format), key=f"format_{book_id}")
